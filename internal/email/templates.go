...
<body style="font-family: sans-serif; max-width: 560px; margin: 40px auto; color: #111;">
  <h2>You've been invited to join <strong>%s</strong> on Winnow</h2>
  ...
  <p style="color:#999;font-size:12px;">Winnow · AI context management · winnow.xferops.dev</p>
</body>
</html>`, orgName, inviteURL)

	text = fmt.Sprintf(
		"You've been invited to join %s on Winnow.\n\nAccept your invitation: %s\n\nThis link expires in 48 hours.",
		orgName, inviteURL,
	)
	return
}
...
<html>
<body style="font-family: sans-serif; max-width: 560px; margin: 40px auto; color: #111;">
  <h2>You've been added to <strong>%s</strong> on Winnow</h2>
  <p>You already have a Winnow account. Log in to access your new org.</p>
  <p style="margin: 32px 0;">
    <a href="%s"
       style="background:#111;color:#fff;padding:12px 24px;border-radius:6px;text-decoration:none;font-weight:bold;">
      Log In
  ...
  <p style="color:#999;font-size:12px;">Winnow · AI context management · winnow.xferops.dev</p>
	...
	text = fmt.Sprintf(
		"You've been added to %s on Winnow. Log in to access it: %s",
		orgName, loginURL,
	)
	return
}
